...
{
	static Logger log = Logger.getLogger(DeleteStudentDAO.class);

	public int DeleteStudent (final int studentid) throws DAOAppException {
		...
		try {
			...
			res = DBHelper.executeUpdate(con, SqlMapper.DELETE_STUDENT, mapper);
