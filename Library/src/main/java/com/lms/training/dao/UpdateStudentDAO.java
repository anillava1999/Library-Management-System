...
{
	static Logger log = Logger.getLogger(UpdateStudentDAO.class);

	public int  UpdateStudent (final int id,final String cno) throws DAOAppException {
		...
		try {
			...
			res = DBHelper.executeUpdate(con, SqlMapper.UPDATE_STUDENT, mapper);
