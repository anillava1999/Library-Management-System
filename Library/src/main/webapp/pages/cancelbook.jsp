...
<div class="container  login-container2 offset-1">
            <div class="row justify-content-center ">
                <div class="col-md-6 login-form-1 col-mb-1 col-mt-1">
                    <h3>Cancel Book Form</h3>
                    <form action="cancelbook.do">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Cancel Book Name" name="cancelbook" />
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control" placeholder="Enter Cancel Book Date" name="canceldate" />
                        </div>
                    
                        <div class="form-group d-flex justify-content-center align-items-center container">
                            <input type="submit" class="btnSubmit " value="Cancel Book" />
                        </div>
