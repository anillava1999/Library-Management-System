            ...
            <div class="row justify-content-center ">
                <div class="col-md-6 login-form-1 col-mb-1 col-mt-1">
                    ...
                    <form action="adminregister.do"  method="post">
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" placeholder="Enter Admin Password " name="adminpassword" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Admin RollID" name="adminroleid" />
                        </div>
                        <div class="form-group">
                            <input type="email" class="form-control" placeholder="Enter Admin Email" name="adminemailid" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Admin Contact No" name="admincontactnumber" />
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center container">
                            <input type="submit" class="btnSubmit " value="Register" />
                        </div>
                        <div class="form-group d-flex justify-content-center align-items-center container ">
                            <a href="adminlogin.jsp" class="ForgetPwd ">Login</a>
                        </div>
