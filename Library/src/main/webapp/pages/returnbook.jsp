...
<div class="container  login-container2 offset-1">
            <div class="row justify-content-center ">
                <div class="col-md-6 login-form-1 col-mb-1 col-mt-1">
                    ...
                    <form action="returnbook.do">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Student ID" name="studentid" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Return Book ISBN " name="isbn" />
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Enter Return Book Name" name="returnbook" />
                        </div>
                        <div class="form-group">
                            <input type="date" class="form-control" placeholder="Enter Return Book Date" name="returndate" />
                        </div>
                    
                        <div class="form-group d-flex justify-content-center align-items-center container">
                            <input type="submit" class="btnSubmit " value="Return Book" />
                        </div>
